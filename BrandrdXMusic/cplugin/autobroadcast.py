...
START_IMG_URLS = "https://graph.org/file/b439f688e8978b9e3f388-358c128986f29a67b1.jpg"
...
🔐ᴜꜱᴇ » [/start](https://t.me/Music_smbot?start=help) ᴛᴏ ᴄʜᴇᴄᴋ ʙᴏᴛ
...
BUTTON = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(
                "๏ ᴋɪᴅɴᴀᴘ ᴍᴇ ๏",
                url=f"https://t.me/Music_smbot?startgroup=s&admin=delete_messages+manage_video_chats+pin_messages+invite_users",
            )
        ]
    ]
)
